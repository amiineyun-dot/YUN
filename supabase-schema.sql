-- ============================================================
-- YUN — Dark Luxury Fashion E-Commerce (Algeria Market)
...
('hero_video_url', ''),
('logo_url', 'https://res.cloudinary.com/dcj7lqvph/image/upload/q_auto/f_auto/v1781461884/IMG_20260531_223119_1_ebk1xo.png'),
...
('about_story', 'paragraph1', 'en', 'YUN was born from the intersection of nostalgia and digital culture. We curate Y2K-inspired fashion that bridges the gap between retro aesthetics and modern streetwear — designed for the generation that grew up in the pixel era.', 2),
...
('about_story', 'paragraph1', 'ar', 'ولدت YUN من تقاطع الحنين والثقافة الرقمية. نقدم أزياء مستوحاة من Y2K تسد الفج بين الجماليات العصرية والملابس العصرية — مصممة للجيل الذي نشأ في عصر البكسل.', 2),
...
('about_story', 'paragraph1', 'fr', 'YUN est née de l''intersection de la nostalgie et de la culture numérique. Nous sélectionnons des mode inspirée du Y2K qui fait le pont entre les esthétiques rétro et le streetwear moderne — conçue pour la génération qui a grandi à l''ère du pixel.', 2),
